...
function generateDeviceId(): string {
  // Use the Web Crypto API for a cryptographically secure UUID (available in RN 0.73+ / Expo SDK 50+).
  // Falls back to Math.random() only in environments that genuinely lack crypto (e.g. old Jest).
